...
import img1 from '../../../assets/Screenshot (5).png'
import img2 from '../../../assets/Screenshot (6).png'
...
const Details3 = () => {
    return (
        ...
        <div className='mb-5'>
            ...
            <h2 className='text-center'>That was all about my <span className='text-2xl  font-bold'>The Dragon news</span> </h2>
        </div>
    </div>
    );
};
